"""
02_cluster_nonamp_sequences.py
================================
Runs sequence redundancy reduction on the non-AMP dataset
using CD-HIT and/or MMseqs2 easy-cluster.

Uses nonamp_clean.fasta from data/intermediate/ (generated in step 01).

Usage:
    python 02_cluster_nonamp_sequences.py                    # both, identity=0.8
    python 02_cluster_nonamp_sequences.py --tool cd-hit      # only CD-HIT
    python 02_cluster_nonamp_sequences.py --tool mmseqs      # only MMseqs2
    python 02_cluster_nonamp_sequences.py --identity 0.9     # custom threshold
"""
...
# input: generated by 01_clean_nonamp_sequences.py
FASTA_INPUT           = DATA_INTERMEDIATE_DIR / "nonamp_clean.fasta"

# outputs
CDHIT_OUTPUT          = RESULTS_DIR / "NONAMP_cdhit.fasta"
CDHIT_CLUSTER_FILE    = RESULTS_DIR / "NONAMP_cdhit.fasta.clstr"
MMSEQS_PREFIX         = RESULTS_DIR / "NONAMP_mmseqs"
MMSEQS_TMP            = RESULTS_DIR / "mmseqs_tmp_nonamp"
...
def setup_logging() -> None:
    ...
    log_file = LOGS_DIR / "02_cluster_nonamp_sequences.log"
    logging.basicConfig(
        level=logging.DEBUG,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reduce non-AMP sequence redundancy with CD-HIT and/or MMseqs2.",
...
def main() -> None:
    ...
    logger.info("Non-AMP redundancy reduction started.")
    ...
    if not FASTA_INPUT.exists():
        logger.error(
            ...
            "Run 01_clean_nonamp_sequences.py first.", FASTA_INPUT
        )
        sys.exit(1)
    ...
    if failed:
        ...
        logger.info("Non-AMP redundancy reduction completed successfully.")
